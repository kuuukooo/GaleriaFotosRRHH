...
// Realiza la consulta para obtener las imágenes de la página actual con el nombre del usuario
$query = "
    ...
    WHERE imagenes_sueltas.es_publico = 1
...
// Obtener el número total de imágenes con es_publico = 1
$queryTotal = "SELECT COUNT(*) as total FROM imagenes_sueltas WHERE es_publico = 1";
