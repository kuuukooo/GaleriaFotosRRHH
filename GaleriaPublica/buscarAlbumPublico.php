...
try {
    ...
    if (isset($_POST['search'])) {
        ...
        if (empty($searchTerm)) {
            ...
            // Query SQL para buscar la imagen por su descripción, solo si es_publico es 1
            $sql = "SELECT 
                        a.id_album, 
                    ...
                    ORDER BY 
                        a.id_album, 
                        i.id_img_alb";
            // Este bloque de código es responsable de ejecutar una consulta SQL para buscar imágenes basadas en un término de búsqueda proporcionado por el usuario.
            ...
            if (empty($result)) {
                ...
                // Este bloque de código está iterando sobre los resultados obtenidos de la consulta SQL para organizar los datos en un formato estructurado antes de codificarlos en JSON para la respuesta.
                foreach ($result as $row) {
                    if ($current_album !== $row["id_album"]) {
                        ...
                        // El if-else checkea si hay imágenes en el álbum y muestra la primera imagen del álbum como miniatura
