...
<body>
        ...
        <!-- NavBar -->
            ...
            <div class="menu-bar">
                ...
                <!-- Iconos de la navbar -->
                    ...
                    <ul class="menu-links" >
                        <li class="nav-link" id="NavPublico">
                            <a href="#imagenes-section" id="hrefPublico">
                                <i class='bx bx-home-alt icon' id="iconoPublico"></i>
                                <span class="text nav-text" id="textoPublico">Imágenes</span>
                            </a>
                        </li>
						<style>
						#hrefPublico, #iconoPublico, #textoPublico {
        ...
        <div class="main-content">
            ...
            <section id="imagenes-section">

                <div class="texto-principal">
                    <span class="titulo">Imágenes</span>
                </div>
            
                <div class="container justify-content-center " id="galeriaContainer">
                <div id="my_nanogalleryImagenes">
...
<script src="indexPublico.js"></script>
</body>
</html>