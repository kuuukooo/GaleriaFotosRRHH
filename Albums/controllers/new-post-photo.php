            ...
            if (count($images) > $maxImages) {
                ...
                if (!isset($response['error'])) {
                    ...
                    if ($description != '') {
                        ...
                        $sql = 'INSERT INTO imagenes_sueltas (id_img_alb, imagen, fecha_carga, id_usuario, id_album, descripcion) VALUES (:id_img_alb, :imagen, :fecha_carga, :id_usuario, :id_album, :descripcion)';
